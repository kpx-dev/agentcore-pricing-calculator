...
export const PricingCalculator: React.FC<PricingCalculatorProps> = ({
  ...
  const hasUsageData = Object.values(usageParameters).some(value => value > 0);
    ...
    <div className={`pricing-calculator ${className}`}>
          ...
          <div className="error-content">
            ...
            <div className="error-details">
              <h3 className="error-title">
                {appError.type === 'calculation' ? 'Calculation Error' :
      ...
      <main className="calculator-content">
        <div className="calculator-grid">
          ...
          {/* Results Section */}
          <section className="results-section" aria-labelledby="results-section-title">
            <h2 id="results-section-title" className="section-title visually-hidden">
      ...
      <footer className="calculator-footer">
        <div className="footer-content">
          ...
          <div className="calculator-info">
            <p>
              Built for developers evaluating AWS Bedrock AgentCore costs. 
